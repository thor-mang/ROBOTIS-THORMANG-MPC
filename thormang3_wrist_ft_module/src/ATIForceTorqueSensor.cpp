...
#include "thormang3_wrist_ft_module/ATIForceTorqueSensor.h"
...
bool ATIForceTorqueSensor::Initialize(const std::string& _ft_data_path,		const std::string& _ft_data_key,
...
void ATIForceTorqueSensor::SetScaleFactror(double _ft_scale_factor)
{
	ft_scale_factor_ = _ft_scale_factor;
}

void ATIForceTorqueSensor::SetNullForceTorque(Eigen::MatrixXd _ft_null)
{
...
void ATIForceTorqueSensor::SetScaleParam(double _ft_scale_factor, Eigen::MatrixXd _ft_null)
{
	SetScaleFactror(_ft_scale_factor);
	SetNullForceTorque(_ft_null);
}

bool ATIForceTorqueSensor::parseFTData(const std::string& _ft_data_path, const std::string& _ft_data_key)
{
	...
	{
		ROS_ERROR("Thormang3WristForceTorqueSensorModule : Fail to load ft_data yaml file.");
		return false;
	}
...
void ATIForceTorqueSensor::SetCurrentVoltageOutput(double _voltage0, double _voltage1, double _voltage2,
...
void ATIForceTorqueSensor::SetCurrentVoltageOutput(Eigen::MatrixXd _voltage)
{
...
Eigen::MatrixXd ATIForceTorqueSensor::GetCurrentForceTorqueRaw()
{
	return ft_raw_;
}

Eigen::MatrixXd ATIForceTorqueSensor::GetCurrentForceTorqueScaled()
{
	return ft_scaled_;
}

void ATIForceTorqueSensor::GetCurrentForceTorqueRaw(double* _force_x_N,   double* _force_y_N,   double* _force_z_N,
...
void ATIForceTorqueSensor::GetCurrentForceTorqueScaled(double* _force_x_N,   double* _force_y_N,   double* _force_z_N,
						     	 	 	 	 	 	   double* _torque_x_Nm, double* _torque_y_Nm, double* _torque_z_Nm)
{
...
void ATIForceTorqueSensor::SetCurrentVoltageOutputPublishForceTorque(double _voltage0, double _voltage1, double _voltage2,
		 	 	 	 	 	 	 	 	 	   	   	   	   	   	  double _voltage3, double _voltage4, double _voltage5)
{
...
void ATIForceTorqueSensor::SetCurrentVoltageOutputPublish(Eigen::MatrixXd _voltage)
{
	if((_voltage.rows() != 6) || (_voltage.cols() != 1)) {
		ROS_ERROR("Invalid voltage size");
		return;
