#ifndef THORMANG3_KINEMATICS_DYNAMICS_H_
#define THORMANG3_KINEMATICS_DYNAMICS_H_


#include <vector>

#include "ThorMang3KinematicsDynamicsDefine.h"
#include "LinkData.h"
...
class ThorMang3KinematicsDynamics
{

public:

	LinkData *thormang3_link_data [ ALL_JOINT_ID + 1 ];
